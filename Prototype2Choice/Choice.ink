...
My first prototype, explores character profiles, so the survey may feel very short. This is okay! Getting the character choices right, is the first step and there are no right or wrong answers to the survey or why you may pick one leader and not another. 

I will be releasing more prototypes and surveys, where the narrative will continue. Which leader you choose will make a difference to the story. Every decision you make will have consequences. 
