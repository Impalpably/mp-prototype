...
You are one of seven leaders, charged with cutting sky-rocketing CO2 emmissions and re-shaping the world as you know it. 
 ...
 * During 'The Great Derrangement' you demonstrated against fracking, fossil fuels and rallied to vote for change. You are an Activist Leader.  -> Chapter3
 //Activist
 * During 'The Great Derrangement' you were a scientist, you published papers on the relentless apocalyptic violence about to be assaulted on the planet. No one listened. You are a Scientist. -> Chapter3
 //Advisor
 * During 'The Great Derrangement' you were a professor and teacher, you spread awareness of how to live sustainably, recycle and protect our planet. You inspired your students and raised a community of climate change educators but it wasn't enough. You are an Educator. -> Chapter3
 //Educator
 * During 'The Great Derrangement' you rejected your individual responsibility, you 'Geo-Political Footprint' and while you recycled and understood that Climate Change is real and happening you simply never really acted to stop it. You are a Nihilist. Now you must act, who will you be? . -> Chapter3
 //Nihilist
 * During 'The Great Derrangement' you saw that your friends didn't bother protesting, recycling or changing the way they lived. No one in the world seemded to really care, so why should you? Now the responsibility falls on you, will you continute to be a Pessimist Leader? Why bother if no one else will? -> Chapter3
 //Pessimist
